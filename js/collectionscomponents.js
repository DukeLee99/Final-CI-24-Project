...
collectionscomponents.collectionspage = `
<div class = "collection-container" id="collectionsPage">
    <div class = "category-container" id = "category">
        <div class="category">
            <div class="field">
                <button  id="jeansField">TROUSERS & JEANS</button>
            </div>
        ...
        <div class="category">
            <div class="field">
                <button id="topsField">TOPS & T-SHIRT</button>
            </div>
            <div class="cover-image">
                <figure>
                    <div class="image">
        ...
        <div class="category">
            <div class="field">
                <button id="jacketField">JACKETS</button>
            </div>
            <div class="cover-image">
                <figure>
                    <div class="image">
        ...
        <div class="category">
            <div class="field">
                <button id="shoesField">SHOES</button>
            </div>
            <div class="cover-image">
                <figure>
                    <div class="image">
